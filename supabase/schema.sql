-- =============================================
-- 🎓 학생 관리 시스템 Supabase Schema (v2.2 - Truly Final)
-- 작성일: 2026-04-07
-- 이 파일 전체를 Supabase SQL Editor에 붙여넣고 실행하세요.
-- 누락되었던 grades, attendances 테이블이 모두 포함되었습니다.
-- =============================================

-- [1] 기존 테이블 및 타입 삭제 (완전 초기화)
...
insert into public.students (name, cohort_id, status, experience, experience_detail, joined_at, gpa, attendance_rate) values
  ('김민준', 2, '수강중', '전공자', '컴퓨터공학', '2025-03-03', 3.8, 85),
  ('이서연', 2, '수강중', '비전공자', '심리학', '2025-03-03', 4.1, 92),
  ('박지훈', 1, '수료', '실무경력', '마케터 2년', '2024-03-04', 2.9, 78);
